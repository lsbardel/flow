# -*- coding: utf-8 -*-
#
# jflow documentation build configuration file, created by
# sphinx-quickstart on Thu Sep  9 23:30:51 2010.
#
...
latex_documents = [
  ('index', 'jflow.tex', u'jflow Documentation',
...
man_pages = [
    ('index', 'jflow', u'jflow Documentation',
     [u'Luca Sbardella'], 1)
]
